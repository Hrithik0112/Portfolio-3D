    ...
    <>
      <AnimatePresence>
        <div className="flex flex-col w-screen min-h-screen justify-center items-center relative bg-primary pb-10">
          ...
          <div className="relative object-cover w-screen h-screen" id="home">
            ...
            <section className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 my-24" id="about">
              ...
              <div className="w-full h-420 flex flex-col items-center justify-center ">
                <p className="text-lg text-textBase text-center">
                  As an aspiring Frontend and Fullstack Developer student, my passion lies in
                  crafting immersive digital experiences. Eagerly seeking opportunities to merge
                  creativity with technical prowess, I strive to bridge user-centric design with
                  seamless functionality. With a commitment to continuous learning, I'm poised to
                  contribute innovative solutions and enhance user engagement in the dynamic world
                  of web development.
                </p>
                ...
                Projects.map((n, i) => (
                  ...
                  >
                    ...
                    <div className="flex flex-1 items-center justify-between">
                      ...
                      <motion.a whileTap={{ scale: 0.8 }} href={n.github}>
                        <div>
                ...
                {SocialLinks &&
                  SocialLinks.map((n) => (
                    <motion.a
                      ...
                      href={n.link}
                      key={n.id}
                      className="w-full md:w-auto px-3 md:px-8 py-5 border border-zinc-800 rounded-2xl
                     hover:border-zinc-600 duration-100 ease-in-out cursor-pointer flex 
